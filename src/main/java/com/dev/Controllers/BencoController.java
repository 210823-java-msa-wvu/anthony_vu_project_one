        ...
        if (path == null || path.equals("")) { // http://localhost:8080/LibraryServlet/books
            ...
            switch (request.getMethod()) {
                ...
                case "POST": {
                    ...
                    Employee ee = er.getById(eid);

                    Integer totalbene = ee.getTotBenefits();
                    System.out.println(totalbene);
                    ...
                    System.out.println("Employee ID: " + id + "  Admin Decision: " + choice + "  Admin Level: " + adminlevel + "  Department: Department " + reim);
